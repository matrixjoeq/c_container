...
#define C_BE_LIST_INT c_list_create_backend(&c_int_t)
#define C_BE_LIST_SINT c_list_create_backend(&c_signed_int_t)
#define C_BE_LIST_UINT c_list_create_backend(&c_unsigned_int_t)
#define C_BE_LIST_SHORT c_list_create_backend(&c_short_t)
#define C_BE_LIST_SSHORT c_list_create_backend(&c_signed_short_t)
#define C_BE_LIST_USHORT c_list_create_backend(&c_unsigned_short_t)
#define C_BE_LIST_LONG c_list_create_backend(&c_long_t)
#define C_BE_LIST_SLONG c_list_create_backend(&c_signed_long_t)
#define C_BE_LIST_ULONG c_list_create_backend(&c_unsigned_long_t)
#define C_BE_LIST_CHAR c_list_create_backend(&c_char_t)
#define C_BE_LIST_SCHAR c_list_create_backend(&c_signed_char_t)
#define C_BE_LIST_UCHAR c_list_create_backend(&c_unsigned_char_t)
#define C_BE_LIST_FLOAT c_list_create_backend(&c_float_t)
#define C_BE_LIST_DOUBLE c_list_create_backend(&c_double_t)
